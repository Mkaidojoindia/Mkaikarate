  ...
  return (
    <div className="about-page">
      ...
      <p>
        ...
        However, the journey began much earlier. Sensei K. Manikandan started
        conducting karate classes in 2011 in Kolathur, training students with
        dedication and passion. What began as a small group of committed
        learners gradually evolved into a strong and disciplined karate
        community. <br></br>
        ...
        strong character in practitioners of all ages. As the guiding force
        behind MKAI Karate, Sensei Manikandan brings years of experience in both
        traditional and competitive karate. He emphasizes technical excellence,
        mental strength, and leadership development, inspiring students to
        achieve their full potential both on and off the mat.
      </p>
      ...
      <p>
        ...
        fighting
        <br></br> Goju-Ryu Karate is designed not only to build powerful
      ...
      <p>
        Gradings are conducted under the supervision of Chief Examiner – Sensei
        K. Manikandan (4th Dan, KIO – National Judge) along with our Assistant
        Instructors. Evaluations focus on technical skill, attitude, discipline,
        and overall character, helping students grow in all aspects. This
        grading system is designed to challenge students at the right level,
        encourage steady improvement, and celebrate their achievements.
        Excellence in tournaments and demonstrations is also recognized,
        reinforcing the values of commitment, hard work, and integrity.
      </p>
    </div>
  );
}
